...
public class EXNBlocks {
          ...
          () ->
              new NetherCrucibleBlock(
                  BlockBehaviour.Properties.of()
                      .strength(1.0F)
                      .sound(
                          Config.getNetherCrucibleSoundsEnabled() ? SoundType.STEM : SoundType.WOOD)
                      .noOcclusion()));
  ...
  public static final BlockDefinition<BarrelBlock> CRIMSON_BARREL =
      BLOCKS.block(
          ...
          "crimson_barrel",
          () ->
              new NetherBarrelBlock(
                  BlockBehaviour.Properties.of()
                      .strength(1.0F)
                      .sound(
                          Config.getNetherBarrelSoundsEnabled() ? SoundType.STEM : SoundType.WOOD)
                      .noOcclusion()));
  ...
  public static final BlockDefinition<SieveBlock> CRIMSON_SIEVE =
      BLOCKS.block(
          ...
          "crimson_sieve",
          () ->
              new NetherSieveBlock(
                  BlockBehaviour.Properties.of()
                      .strength(1.0F)
                      .sound(
                          Config.getNetherSieveSoundsEnabled()
                              ? SoundType.STEM
