...
// import net.minecraft.world.item.ToolMaterial;  // This is for 1.21.3+
...
public class EXNItems {
  ...
  public static final ItemDefinition<SilkwormItem> SILKWORM =
      ITEMS.item(
          "Silkworm",
          "silkworm",
          () -> new SilkwormItem(new Item.Properties()),
          ItemDefinition.ItemType.OTHER);
  ...
  public static final ItemDefinition<ResourceItem> MYCELIUM_SPORE =
      ITEMS.item(
          "Mycelium Spores",
          "mycelium_spores",
          () -> new ResourceItem(Blocks.DIRT, Blocks.MYCELIUM, new Item.Properties()),
          ItemDefinition.ItemType.OTHER);
  // This is for 1.21.3+
  // ITEMS.resourceItem(
  //     "Mycelium Spores",
  ...
  public static final ItemDefinition<ResourceItem> CRIMSON_NYLIUM_SPORE =
      ITEMS.item(
          ...
          () -> new ResourceItem(Blocks.NETHERRACK, Blocks.CRIMSON_NYLIUM, new Item.Properties()),
          ItemDefinition.ItemType.OTHER);
  // This is for 1.21.3+
  // ITEMS.resourceItem(
  //     "Crimson Nylium Spores",
  ...
  public static final ItemDefinition<ResourceItem> WARPED_NYLIUM_SPORE =
      ITEMS.item(
          ...
          () -> new ResourceItem(Blocks.NETHERRACK, Blocks.WARPED_NYLIUM, new Item.Properties()),
          ItemDefinition.ItemType.OTHER);
  // This is for 1.21.3+
  // ITEMS.resourceItem(
  //     "Warped Nylium Spores",
  ...
  public static final ItemDefinition<ResourceItem> GRASS_SEED =
      ITEMS.item(
          "Grass Seeds",
          "grass_seeds",
          () -> new ResourceItem(Blocks.DIRT, Blocks.GRASS_BLOCK, new Item.Properties()),
          ItemDefinition.ItemType.OTHER);
  // This is for 1.21.3+
  // ITEMS.resourceItem(
  //     "Grass Seeds",
  ...
  public static final ItemDefinition<CrookItem> CROOK_BAMBOO =
      ITEMS.item(
          "Bamboo Crook",
          "bamboo_crook",
          () -> new CrookItem(Tiers.STONE, Config.getCrookBambooDurability()),
          ItemDefinition.ItemType.TOOL);
  // This is for 1.21.3+
  // ITEMS.crookItem(
  //     "Bamboo Crook",
  ...
  public static final ItemDefinition<CrookItem> CROOK_BASALT =
      ITEMS.item(
          "Basalt Crook",
          "basalt_crook",
          () -> new CrookItem(Tiers.STONE, Config.getCrookBasaltDurability()),
          ItemDefinition.ItemType.TOOL);
  // This is for 1.21.3+
  // ITEMS.crookItem(
  //     "Basalt Crook",
  ...
  public static final ItemDefinition<CrookItem> CROOK_BLACKSTONE =
      ITEMS.item(
          "Blackstone Crook",
          "blackstone_crook",
          () -> new CrookItem(Tiers.STONE, Config.getCrookBlackstoneDurability()),
          ItemDefinition.ItemType.TOOL);
  // This is for 1.21.3+
  // ITEMS.crookItem(
  //     "Blackstone Crook",
  ...
  public static final ItemDefinition<CrookItem> CROOK_CALCITE =
      ITEMS.item(
          "Calcite Crook",
          "calcite_crook",
          () -> new CrookItem(Tiers.STONE, Config.getCrookCalciteDurability()),
          ItemDefinition.ItemType.TOOL);
  // This is for 1.21.3+
  // ITEMS.crookItem(
  //     "Calcite Crook",
  ...
  public static final ItemDefinition<CrookItem> CROOK_COPPER =
      ITEMS.item(
          "Copper Crook",
          "copper_crook",
          () -> new CrookItem(Tiers.IRON, Config.getCrookCopperDurability()),
          ItemDefinition.ItemType.TOOL);
  // This is for 1.21.3+
  // ITEMS.crookItem(
  //     "Copper Crook",
  ...
  public static final ItemDefinition<CrookItem> CROOK_GOLD =
      ITEMS.item(
          "Golden Crook",
          "golden_crook",
          () -> new CrookItem(Tiers.GOLD, Config.getCrookGoldDurability()),
          ItemDefinition.ItemType.TOOL);
  // This is for 1.21.3+
  // ITEMS.crookItem(
  //     "Golden Crook",
  ...
  public static final ItemDefinition<HammerItem> HAMMER_COPPER =
      ITEMS.item(
          "Copper Hammer",
          "copper_hammer",
          () -> new HammerItem(Tiers.IRON, Config.getCrookCopperDurability()),
          ItemDefinition.ItemType.TOOL);
  // This is for 1.21.3+
  // ITEMS.hammerItem(
  //     "Copper Hammer",
