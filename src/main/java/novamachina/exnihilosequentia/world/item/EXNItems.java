...
public class EXNItems {
  ...
  public static final ItemDefinition<Item> COOKED_SILKWORM =
      ITEMS.item(
          ...
          // Item::new,
          () -> new Item(new Item.Properties() .food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.6F).build())),  // This is generated by AI.
  ...
  public static final ItemDefinition<BucketItem> WITCH_WATER_BUCKET =
      ITEMS.item(
          "Witch Water Bucket",
          "witch_water_bucket",
          () -> new BucketItem(EXNFluids.WITCH_WATER.getStillFluid(), new Item.Properties().stacksTo(1)),
          ItemDefinition.ItemType.OTHER);
      // This is for 1.21.3+
      // ITEMS.bucketItem(
      //     "Witch Water Bucket",
  ...
  public static final ItemDefinition<BucketItem> SEA_WATER_BUCKET =
      ITEMS.item(
          "Sea Water Bucket",
          "sea_water_bucket",
          () -> new BucketItem(EXNFluids.SEA_WATER.getStillFluid(), new Item.Properties().stacksTo(1)),
          ItemDefinition.ItemType.OTHER);
      // This is for 1.21.3+
      // ITEMS.bucketItem(
      //     "Sea Water Bucket",
